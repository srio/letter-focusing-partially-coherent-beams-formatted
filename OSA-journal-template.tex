...
% Slit transmittivity $T$ is and Fresnel number $N_F$ at the slit plane are also marked. 
...
% The coherence fraction of the transmitted beam for each slit aperture is marked in legend in the multi-mode cases.
}
\label{fig:oneTFund}
\end{figure}
...
% \textbf{Acknowledgements}. The authors want to acknowledge J.P Guigay for discussions.
