...
\hspace*{-1.0cm}
\centering
\includegraphics[width=0.8\textwidth]{figures/evolution-eps-converted-to.pdf}
...
a)\\
\hspace{-2.0cm}
    \includegraphics[width=0.40\textwidth]{figures/sizes_h-eps-converted-to.pdf}\\
b)\\
\hspace{-2.0cm}
    \includegraphics[width=0.40\textwidth]{figures/sizes_v-eps-converted-to.pdf}
